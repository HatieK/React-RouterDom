        ...
        <section className="hero">
          <div className="hero__content">
            <div className="container">
              ...
              <p className="text">
                Dạy từ kinh nghiệm, học từ thực tế để tạo ra sản phẩm có giá
                trị.
              </p>
                    ...
                    <div className="images">
                      <div className="list">
                        <div className="carousel-cell">
                          ...
                          <div className="ct_m">
                            ...
                            <div className="content">
                              ...
                              front-end dev. Mentor hỗ trợ nhiệt tình, lên lớp
                              học lý thuyết xong là thực chiến luôn. Sau khoá
                              học thì được giảng viên chia sẻ kinh nghiệm.
                            </div>
                            <div className="bottom">
                              <span className="label">Học viên CFD1</span>
                              <a
                        ...
                        <div className="carousel-cell">
                          ...
                          <div className="content">
                            Là một nơi truyền cảm hứng cho mình thực hiện tiếp
                            ước mơ và hoài bảo! Cảm ơn các thầy đã nổ lực hỗ trợ
                            để mình có thể tiếp cận ước mơ của mình gần hơn.
                          </div>
                          <div className="bottom">
                            <span className="label">Học viên CFD2</span>
                            <a href="https://www.facebook.com/" target="_blank">
                        ...
                        <div className="carousel-cell">
                          ...
                          <div className="ct_m">
                            ...
                            <div className="content">
                              ...
                              trọng, sau khóa học mình đã tự code được 2 dự án
                              riêng, 4 mentor dạy và hỗ trợ học viên rất có tâm,
                              chuyện livestream giải đáp thắc mắc cho học viên
                              tới khuya là thường xuyên. Sau khóa học mình học
                              được cách tạo giao diện sao cho đẹp tinh tế, thân
                        ...
                        <div className="carousel-cell">
                          ...
                          <div className="ct_m">
                            ...
                            <div className="content">
                              Khóa học thực sự chất lượng, anh Nghĩa và mentor
                              hỗ trợ rất nhiệt tình. Sau khóa học riêng mình cảm
                              thấy học hỏi được rất nhiều.
                            </div>
                            <div className="bottom">
                              <span className="label">Học viên CFD1</span>
                              <a
